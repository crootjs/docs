...
```javascript
import { toast, toastSuccess, toastError, toastWarning, toastInfo } from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.8/toast.js";
```
...
```javascript
import { toastInfo } from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.8/toast.js";
