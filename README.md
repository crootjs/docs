...
- [toast.js](toast) — notifikasi ringan tanpa dependency eksternal (`toast`, `toastSuccess`, `toastError`, `toastWarning`, `toastInfo`)
...
2. main.js : pengaturan login menggunakan crootjs
   ```js
   import {qrController,deleteCookie,appendGoogleSignin} from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.11/auth.js";
   import { wauthparam } from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.11/config.js";
...
Pada file index.js
```js
import {getCookie} from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.11/cookie.js";
import {getJSON} from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.11/api.js";
import {redirect} from "https://cdn.jsdelivr.net/gh/crootjs/lib@0.0.11/url.js";
